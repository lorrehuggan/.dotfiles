...
lvim.keys.normal_mode["<leader>ss"] = ":nohlsearch <CR>"
lvim.keys.normal_mode["<leader>r"] = ":NvimTreeFocus <CR>"
-- visual mode
lvim.keys.visual_mode["<A-j>"] = ":move .+1<CR>=="
lvim.keys.visual_mode["<A-k>"] = ":move .-1<CR>=="
-- insert mode
